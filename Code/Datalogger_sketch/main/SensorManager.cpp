...
void SensorManager::begin() {
 ...
 //   rtc.adjust(DateTime(2026, 5, 28, 14, 24, 45));
...
int SensorManager::readSoundLevel() {
  ...
  Serial.print("esp_err_t: "); Serial.println(result);
  ...
  Serial.print("Sample count: "); Serial.println(count);

  // Vis de første 10 rå samples
  Serial.println("Første 10 rå samples (32-bit hex + decimal):");
  ...
  Serial.print("Max råværdi: "); Serial.println(maxVal);
  Serial.print("Min råværdi: "); Serial.println(minVal);
  Serial.print("Peak-to-peak: "); Serial.println(maxVal - minVal);

  // Vis hvad >> 8 giver
  Serial.print("Max >> 8: "); Serial.println(maxVal >> 8);
  Serial.print("Max >> 14: "); Serial.println(maxVal >> 14);
  ...
  Serial.print("RMS med >>8: "); Serial.println(rms8);
  ...
  Serial.print("RMS med >>14: "); Serial.println(rms14);
